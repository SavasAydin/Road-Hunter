...
/**
 * This class includes implementation of the Dijkstra algorithm and find the
 * shortest path between two nodes and allows you to set the nodes as start and
 * end point
 * 
 * @author Savas Aydin
 */
public class Dijkstra {
	public static Vertex v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12,
	...
	public void setUpDijkstra() {
		...
		v1.adjacencies = new Edge[] { new Edge(v3, 42), new Edge(v2, 25) };

		v2.adjacencies = new Edge[] { new Edge(v1, 25) };

		v3.adjacencies = new Edge[] { new Edge(v1, 42), new Edge(v6, 68),
				new Edge(v33, 190) };

		v4.adjacencies = new Edge[] { new Edge(v5, 56), new Edge(v7, 66) };

		v5.adjacencies = new Edge[] { new Edge(v4, 56), new Edge(v6, 90),
				new Edge(v8, 65) };

		v6.adjacencies = new Edge[] { new Edge(v3, 68), new Edge(v5, 90),
				new Edge(v22, 34), new Edge(v10, 80), new Edge(v35, 47) };

		v7.adjacencies = new Edge[] { new Edge(v4, 66), new Edge(v8, 57),
				new Edge(v12, 65) };

		v8.adjacencies = new Edge[] { new Edge(v5, 65), new Edge(v7, 57),
				new Edge(v9, 91), new Edge(v13, 65) };

		v9.adjacencies = new Edge[] { new Edge(v22, 27), new Edge(v8, 91),
				new Edge(v10, 94), new Edge(v23, 34) };

		v10.adjacencies = new Edge[] { new Edge(v6, 80), new Edge(v9, 94),
				new Edge(v34, 110), new Edge(v15, 72), new Edge(v16, 99),
				new Edge(v24, 24) };

		v11.adjacencies = new Edge[] { new Edge(v34, 59), new Edge(v32, 26),
				new Edge(v33, 63) };

		v12.adjacencies = new Edge[] { new Edge(v7, 65), new Edge(v13, 58),
				new Edge(v18, 140) };

		v13.adjacencies = new Edge[] { new Edge(v8, 65), new Edge(v12, 58),
				new Edge(v25, 36) };

		v14.adjacencies = new Edge[] { new Edge(v25, 52), new Edge(v37, 31),
				new Edge(v27, 23), new Edge(v19, 130) };

		v15.adjacencies = new Edge[] { new Edge(v27, 67), new Edge(v10, 72),
				new Edge(v16, 110), new Edge(v20, 150) };

		v16.adjacencies = new Edge[] { new Edge(v10, 99), new Edge(v34, 69),
				new Edge(v15, 110), new Edge(v28, 92) };

		v17.adjacencies = new Edge[] { new Edge(v32, 84), new Edge(v29, 96) };

		v18.adjacencies = new Edge[] { new Edge(v12, 140), new Edge(v19, 160) };

		v19.adjacencies = new Edge[] { new Edge(v18, 160), new Edge(v14, 130),
				new Edge(v20, 79) };

		v20.adjacencies = new Edge[] { new Edge(v19, 79), new Edge(v15, 150),
				new Edge(v36, 94) };

		v21.adjacencies = new Edge[] { new Edge(v28, 52), new Edge(v36, 25) };

		v22.adjacencies = new Edge[] { new Edge(v6, 34), new Edge(v9, 27) };

		v23.adjacencies = new Edge[] { new Edge(v9, 34), new Edge(v37, 1) };

		v24.adjacencies = new Edge[] { new Edge(v10, 24), new Edge(v35, 27) };

		v25.adjacencies = new Edge[] { new Edge(v13, 36), new Edge(v14, 52) };

		v26.adjacencies = new Edge[] { new Edge(v27, 39) };

		v27.adjacencies = new Edge[] { new Edge(v14, 23), new Edge(v15, 67),
				new Edge(v26, 39) };

		v28.adjacencies = new Edge[] { new Edge(v21, 52), new Edge(v16, 92) };

		v29.adjacencies = new Edge[] { new Edge(v17, 96), new Edge(v30, 35) };

		v30.adjacencies = new Edge[] { new Edge(v29, 35), new Edge(v31, 34) };

		v31.adjacencies = new Edge[] { new Edge(v32, 43), new Edge(v30, 34) };

		v32.adjacencies = new Edge[] { new Edge(v11, 36), new Edge(v31, 43),
				new Edge(v17, 84) };

		v33.adjacencies = new Edge[] { new Edge(v3, 190), new Edge(v11, 63) };

		v34.adjacencies = new Edge[] { new Edge(v10, 110), new Edge(v11, 47),
				new Edge(v16, 69) };

		v35.adjacencies = new Edge[] { new Edge(v24, 110), new Edge(v11, 61),
				new Edge(v6, 47) };

		v36.adjacencies = new Edge[] { new Edge(v21, 25), new Edge(v20, 94) };

		v37.adjacencies = new Edge[] { new Edge(v23, 1), new Edge(v14, 31) };
	}
	...
	public void setStartTarget(Vertex startV, Vertex endV) {
		implementationDijkstra(startV); // v1=source vertex
		{
			...
			System.out.println("Distance to " + endV + ": " + endV.minDistance);
