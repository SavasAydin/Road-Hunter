...
/**
 * The ScreenShot class takes a screen shot of the whole screen and saves it as
 * a .jpeg file. The class is supposed to be used after a completed navigation
 * session to be able to look upon the traveled route, both immediately after
 * the session and later to see the last navigation session.
 * 
