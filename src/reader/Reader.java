...
/**
 * This class reads serial data and identifies serial port connection. There is
 * main method to test codes
 * 
...
public class Reader implements Runnable, SerialPortEventListener {
		...
		while (portList.hasMoreElements()) {
			...
			if (portId.getPortType() == CommPortIdentifier.PORT_SERIAL) {
				if (portId.getName().equals("COM1")
						|| portId.getName().equals("COM2")
						|| portId.getName().equals("COM3")
						|| portId.getName().equals("COM4")
						|| portId.getName().equals("COM5")
						|| portId.getName().equals("COM6")
						|| portId.getName().equals("COM7")
						|| portId.getName().equals("COM8")
						|| portId.getName().equals("COM9")
	...
	public void serialEvent(SerialPortEvent event) {
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			try {
				ifile = new BufferedReader(new InputStreamReader(
			...
			/*
			 * if(gpsData.dataFound == true){ try { inputStream.close(); } catch
	...
	/*
	 * public static void cutStream(){ try { stop(); } catch
